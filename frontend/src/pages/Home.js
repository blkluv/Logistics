...
const Home = () => {
  ...
  const testimonials = [
    ...
    {
      quote: "Route It transformed our last-mile delivery. Customer satisfaction increased by 35% due to faster deliveries.",
      author: "Rajesh Kumar",
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex justify-center gap-6">
              <a 
                href="https://github.com/UtkarshSingh19062004/" 
                target="_blank" 
              ...
              <a 
                href="https://www.linkedin.com/in/utkarsh-singh-493707157" 
                target="_blank" 
                rel="noopener noreferrer"
